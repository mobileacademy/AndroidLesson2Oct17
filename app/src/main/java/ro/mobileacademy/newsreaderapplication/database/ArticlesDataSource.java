...
//    }
    ...
    public Article createArticle(long id, String title, long time, String url, int publicationId) {
    ...
    private Article cursorToArticle(Cursor cursor) {
        ...
        article.setTime(cursor.getLong(cursor.getColumnIndex(MyDatabaseHelper.ARTICLE_COLUMN_TIME)));
