...
public class OldArticleListActivity extends AppCompatActivity {

    private static final String TAG = OldArticleListActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.old_activity_article_list);
